 ...
 *
 * <p><b>Why these annotations are here rather than on {@code RefillRadarApplication}.</b>
...
@Configuration
@Profile("!memory")
@EntityScan(basePackages = {"com.refillradar.store.jpa", "com.commonauth.store.jpa"})
@EnableJpaRepositories(basePackages = {"com.refillradar.store.jpa", "com.commonauth.store.jpa"})
