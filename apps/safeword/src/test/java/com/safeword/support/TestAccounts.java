 ...
 *
 * <p>Exists because {@code circles.owner_account_id} is a foreign key, so a test that wants
 * to store a circle must first have an account for it to belong to. That is the constraint
 * working: in v0.1 a circle belonged to nobody, which is why anyone could read one.
 */
