...
public class DatabaseCleaner {
    ...
    @Transactional
    public void clean() {
        // circle_members and circles go in the same statement as users: PostgreSQL refuses
        // to truncate a table another one references unless they are named together.
        jdbc.execute("TRUNCATE TABLE circle_members, circles, users");
