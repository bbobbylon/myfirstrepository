 ...
 *
 * <p>Shortcuts the login round trip for tests whose subject is something other than logging in.
 * The real register/login/logout flow is exercised end to end by the container smoke test in CI
 * and by the shared module's own tests, so it is covered by something rather than assumed
 * everywhere.
 */
